...
<div class="container">
        <div class="row py-4">
            ...
            <a class="btn btn-outline" href="<?php echo e(route('theme.page.about')); ?>">Contact Us</a>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    <div class="card product-card">
                        <div class="text-center py-4">
                            <img src="<?php echo e(route('theme.image',['name'=>'yolk4.png'])); ?>" alt="" class="product-icons">
                        </div>
                        <div class="card-body text-center">
                            ...
                            <br>    
                            <a href="<?php echo e(route('theme.page.gcsuite')); ?>" class="btn btn-outline2">Learn More</a>
                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    <div class="card product-card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <br>    
                            <a href="<?php echo e(route('theme.page.yecampus')); ?>" class="btn btn-outline2">Learn More</a>
                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    <div class="card product-card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <br>
                            <a href="<?php echo e(route('theme.page.yeculture')); ?>" class="btn btn-outline2">Learn More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    <div class="card product-card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <br>
                            <a href="<?php echo e(route('theme.page.zoffsites')); ?>" class="btn btn-outline2">Learn More</a>
                        </div>
                    </div>
                </div>
