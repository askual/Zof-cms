...
<meta charset="utf-8">
<title>
  Askual Client: <?php echo $__env->yieldContent('title'); ?>
</title>
  ...
  <link rel="stylesheet" href="<?php echo e(url('adminlte/css/skins/skin-red.css')); ?>">
...
<div class="wrapper">
  ...
  <header class="main-header">
    <a href="<?php echo e(route('client.index')); ?>" class="logo">
  ...
  <aside class="main-sidebar" id="menu">
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if(null !== config($m->getLowerName().'.client-routes')): ?>
        ...
        <li>
          <a class="dropdown-item" href="<?php echo e(route('client.logout')); ?>" ><i class="fa fa-sign-out"></i><span>Logout</span></a>
        </li>
      </ul>
    </section>
  </aside>
