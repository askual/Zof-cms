        ...
        <div class="container">
            ...
            <div class="row prod-card">
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="card product-card">
                        <div class="text-center py-4">
                            <img src="<?php echo e(route('theme.image',['name'=>'kib.png'])); ?>" alt="" class="product-icons">
                        </div>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="card product-card">
                        <div class="text-center py-4">
                            <img src="<?php echo e(route('theme.image',['name'=>'abe.png'])); ?>" alt="" class="product-icons">
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="card product-card">
                        <div class="text-center py-4">
                            <img src="<?php echo e(route('theme.image',['name'=>'yiw.png'])); ?>" alt="" class="product-icons">
                        </div>
                        <div class="card-body text-center">
                            <p>Yiwosin Dagne</p>
                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    <div class="card product-card">
                        <div class="text-center py-4">
                            <img src="<?php echo e(route('theme.image',['name'=>'tad.png'])); ?>" alt="" class="product-icons">
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    <div class="card product-card">
                        <div class="text-center py-4">
                            <img src="<?php echo e(route('theme.image',['name'=>'yet.png'])); ?>" alt="" class="product-icons">
                        </div>
                        <div class="card-body text-center">
