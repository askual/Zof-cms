<?php $__env->startSection('content'); ?>
  ...
  <section id="hero" class="wow fadeIn">
    <div class="hero-container">
      ...
      <a href="<?php echo e(route('join')); ?>" class="btn-get-started scrollto">Join Us</a>
      <div class="btns">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            ...
            <img src="<?php echo e(url('theme2/img/svg/cloud.svg')); ?>" alt="img" class="img-fluid">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            <img src="<?php echo e(url('theme2/img/svg/planet.svg')); ?>" alt="img" class="img-fluid">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="feature-block">
            <img src="<?php echo e(url('theme2/img/svg/asteroid.svg')); ?>" alt="img" class="img-fluid">
    ...
    <div class="overlay padd-section">
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <ul class="list-unstyled">
            <li><a href="facebook.com/alenethiopia"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
