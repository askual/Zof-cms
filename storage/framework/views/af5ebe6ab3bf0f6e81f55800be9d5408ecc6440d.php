            ...
            <div class="row prod-card">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="card product-card">
                            <div class="row">
                                <div class="col-sm-7">
                                    <img src="<?php echo e(route('theme.image',['name'=>'gc0.webp'])); ?>" alt="" class="img-fluid">
                                </div>
                                <div class="col-sm-5">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="card product-card">
                            <div class="row">
                                <div class="col-sm-7">
                                    <img src="<?php echo e(route('theme.image',['name'=>'gc1.webp'])); ?>" alt="" class="img-fluid">
                                </div>
                                <div class="col-sm-5">
                                    <p>Interactive pics</p>
                                    <small class="text-grey">A platform for Graduating Class students.</small>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="card product-card">
                            <div class="row">
                                <div class="col-sm-7">
                                    <img src="<?php echo e(route('theme.image',['name'=>'gc2.webp'])); ?>" alt="" class="img-fluid">
                                </div>
                                <div class="col-sm-5">
                                    <p>Interactive pics</p>
                                    <small class="text-grey">A platform for Graduating Class students.</small>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="card product-card">
                            <div class="row">
                                <div class="col-sm-7">
                                    <img src="<?php echo e(route('theme.image',['name'=>'gc3.webp'])); ?>" alt="" class="img-fluid">
                                </div>
                                <div class="col-sm-5">
                                    <p>Interactive pics</p>
                                    <small class="text-grey">A platform for Graduating Class students.</small>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="card product-card">
                            <div class="row">
                                <div class="col-sm-7">
                                    <img src="<?php echo e(route('theme.image',['name'=>'gc4.webp'])); ?>" alt="" class="img-fluid">
                                </div>
                                <div class="col-sm-5">
                                    <p>Interactive pics</p>
                                    <small class="text-grey">A platform for Graduating Class students.</small>
