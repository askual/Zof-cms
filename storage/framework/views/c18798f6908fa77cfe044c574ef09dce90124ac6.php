...
<div class="swiper-container hero-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide hero-content-wrap">
                <img src="<?php echo e(url('images/main/top-1.jpg')); ?>" alt="">
            ...
            <div class="swiper-slide hero-content-wrap">
                <img src="<?php echo e(url('images/main/top-2.jpg')); ?>" alt="">
            ...
            <div class="swiper-slide hero-content-wrap">
                <img src="<?php echo e(url('images/main/top-3.jpg')); ?>" alt="">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 mt-4 order-1 order-lg-2">
                    ...
                    <!-- <img src="<?php echo e(url('images/welcome.jpg')); ?>" alt="welcome"> -->
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
    </div><!-- .home-page-icon-boxes -->
    ...
    <?php $__env->startSection('leftover'); ?>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="<?php echo e(url('images/cause-1.jpg')); ?>" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="<?php echo e(url('images/cause-2.jpg')); ?>" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="<?php echo e(url('images/cause-3.jpg')); ?>" alt="">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.charity-theme', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>