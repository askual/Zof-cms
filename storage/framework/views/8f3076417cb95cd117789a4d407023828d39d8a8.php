<?php $__env->startSection('content'); ?>
      ...
      <section class="content">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php echo e(route('blog.admin.edit_post_submit')); ?>" enctype="multipart/form-data" method="post">
                <?php echo csrf_field(); ?>
              <input type="hidden" name="post_id" value="<?php echo e($post->id); ?>">
              <div class="form-group">
                <input class="form-control" value="<?php echo e($post->title); ?>" name="title" placeholder="Title:">
              </div>
              <div class="form-group">
<!--                     <textarea id="compose-textarea" name="body" class="form-control" style="height: 300px">
                      
                    </textarea> -->
                    <textarea name="tm" class="form-control"><?php echo e($post->body); ?></textarea>
              </div>
              <div class="form-group">
                ...
                <input id="thumbnail" class="form-control" type="text" name="filepath" value="<?php echo e($post->picture); ?>">
            <img id="holder" style="margin-top:15px;max-height:100px;" src="<?php echo e(url($post->picture)); ?>">
              </div>
            </div>
            <!-- /.box-body -->
