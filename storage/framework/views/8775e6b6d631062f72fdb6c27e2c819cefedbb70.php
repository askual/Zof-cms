...
<div class="container">
      ...
      <section class="content">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php echo e(route('admin.blog_post')); ?>" enctype="multipart/form-data" method="post">
                <?php echo csrf_field(); ?>
            ...
            <div class="box-body no-padding">
              <table class="table">
                ...
                <tr>
                  ...
                  <!-- <td> <img src="<?php echo e(route('blog.image',['name'=>$e->picture])); ?>" height="100"></td> -->
