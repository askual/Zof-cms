			    	...
			    	<div class="row align-items-center justify-content-center d-flex">
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
							...
							@else	<li>
							@endif
							<a href="{{route('theme.page.index')}}">Home </a></li>

							@if(url()->current() == route('theme.page.about'))	<li class="menu-active">
							@else	<li>
							@endif
							<a href="{{route('theme.page.about')}}">About </a></li>

							@if(url()->current() == route('theme.page.gallery'))	<li class="menu-active">
							@else	<li>
							@endif
							<a href="{{route('theme.page.gallery')}}">Gallery </a></li>
							...
							@else	<li>
							@endif
							<a href="{{route('theme.page.resources')}}">Resources </a></li>
