<?php $__env->startSection('content'); ?>
      ...
      <section class="content">
        <div class="col-md-12">
            <form method="POST" action="<?php echo e(route('alensys.admin.members.add')); ?>">
                <?php echo csrf_field(); ?>
                <div class="col-md-4">
          ...
          <div class="box">
            ...
            <div class="box-body no-padding">
              <table class="table">
                ...
                <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
